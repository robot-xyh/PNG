...
class BetaflightWebTest(unittest.TestCase):
    ...
    def test_payload_from_log_row_is_typed_and_grouped(self):
        row = {
            ...
            "command_throttle_target_us": "1320.5",
            "command_thrust_model_voltage_v": "23.8",
            "thrust_model_configured": "1",
            "thrust_model_ready": "1",
            "thrust_model_reason": "ready",
            "thrust_model_calibration_id": "full-6s-lut",
            "thrust_model_sha256": "abc123",
            "thrust_model_voltage_min_v": "20.0",
            "thrust_model_voltage_max_v": "25.2",
            "thrust_model_voltage_v": "23.8",
            "thrust_model_voltage_covered": "1",
            "track_id": "7",
        ...
        self.assertEqual(
            payload["command"]["thrust_feedforward"],
            {
                ...
                "raw_thrust": 0.581,
                "limited": True,
                "target_throttle_us": 1320.5,
                "voltage_v": 23.8,
                "model_status": {
                    "configured": True,
                    "ready": True,
                    "reason": "ready",
                    "calibration_id": "full-6s-lut",
                    "sha256": "abc123",
                    "voltage_coverage_v": [20.0, 25.2],
                    "current_voltage_v": 23.8,
                    "voltage_covered": True,
                },
            },
        )
