...
def _experiment_fields(
    *,
    ...
    return {
        ...
        "intruder_maneuver": str(getattr(args, "intruder_maneuver", "straight")),
        "intruder_maneuver_amplitude_m": float(getattr(args, "intruder_maneuver_amplitude_m", 0.0)),
        "intruder_maneuver_period_s": float(getattr(args, "intruder_maneuver_period_s", 0.0)),
        "intruder_maneuver_phase_deg": float(getattr(args, "intruder_maneuver_phase_deg", 0.0)),
