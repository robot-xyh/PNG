...
|参数|值|
|---|---|
|stamp|`upward_final_yolo_more_20260628_174009`|
...
![summary](assets/YOLO_ByteTrack_upward_final_more_25_30_45_50测试报告/summary_upward_final_yolo_more_20260628_174009.png)

## 4. 汇总表

|组别|碰撞命中|近距命中|碰撞距离m|近距距离m|未命中距离m|最小中心距离m|检测帧/总帧|有效帧/总帧|平均检测FPS|
|---|---:|---:|---|---|---|---:|---:|---:|---:|
|TTC|4/4|0/4|25, 30, 45, 50|-|-|1.610|255/316|249/316|6.73|
|VM|1/4|0/4|45|-|25, 30, 50|1.512|519/709|470/709|6.07|

## 5. 明细表

|组别|距离m|碰撞|近距|碰撞时间s|近距时间s|近距距离m|最小距离m|终点距离m|检测帧率|有效帧率|YOLO FPS|sim FPS|实际过载max g|速度指令差分P95 g|需用过载P95 g|
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|TTC|25|1|0|11.08|-|-|1.622|1.622|90.0%|90.0%|7.09|6.75|0.81|0.94|0.82|
|VM|25|0|0|-|-|-|3.057|6.794|80.6%|82.1%|6.02|5.77|1.40|1.69|1.87|
|TTC|30|1|0|11.23|-|-|1.881|1.954|95.7%|94.2%|6.92|6.61|0.96|1.70|1.79|
|VM|30|0|0|-|-|-|2.668|66.934|67.0%|47.0%|5.96|5.71|1.36|1.79|1.98|
|TTC|45|1|0|13.57|-|-|1.610|1.681|83.3%|82.1%|6.37|6.07|0.86|1.34|0.84|
|VM|45|1|0|18.54|-|-|1.512|1.512|63.2%|64.2%|6.22|5.95|0.99|1.76|1.22|
|TTC|50|1|0|16.67|-|-|1.760|1.760|61.6%|57.6%|6.53|6.25|0.90|1.10|0.57|
|VM|50|0|0|-|-|-|1.993|6.842|77.2%|70.8%|6.06|5.80|1.34|1.38|1.99|

## 6. 分距离曲线

每个距离一张图，包含真实中心距离、bbox 面积、TTC 估计、实际过载/需用过载和 YOLO 检测 FPS。

![25m](assets/YOLO_ByteTrack_upward_final_more_25_30_45_50测试报告/yolo_sitl_ttc_vm_025m.png)
![30m](assets/YOLO_ByteTrack_upward_final_more_25_30_45_50测试报告/yolo_sitl_ttc_vm_030m.png)
![45m](assets/YOLO_ByteTrack_upward_final_more_25_30_45_50测试报告/yolo_sitl_ttc_vm_045m.png)
![50m](assets/YOLO_ByteTrack_upward_final_more_25_30_45_50测试报告/yolo_sitl_ttc_vm_050m.png)

## 7. LOS KF 与失败原因诊断

|组别|距离m|最近距离m|最近点状态|主要失败/降级原因|检测率|有效率|
|---|---:|---:|---|---|---:|---:|
|TTC|25|1.622|`terminal_lost`|valid:39, area_not_expanding:16, bbox_area_jump:5, terminal_lost:5|90.0%|90.0%|
|VM|25|3.057|`valid`|valid:132, terminal_lost:55, image_kf_predict:8, no_detection:5|80.6%|82.1%|
|TTC|30|1.881|`terminal_lost`|valid:46, area_not_expanding:13, terminal_lost:3, bbox_area_jump:2|95.7%|94.2%|
|VM|30|2.668|`terminal_lost`|valid:82, terminal_lost:44, no_detection:34, los_innovation_reject:29|67.0%|47.0%|
|TTC|45|1.610|`valid`|valid:48, no_detection:12, area_not_expanding:12, terminal_lost:2|83.3%|82.1%|
|VM|45|1.512|`terminal_lost`|valid:62, no_detection:33, image_kf_predict:5, bbox_bottom_clipped:3|63.2%|64.2%|
|TTC|50|1.760|`terminal_lost`|valid:44, no_detection:33, terminal_lost:6, area_not_expanding:5|61.6%|57.6%|
|VM|50|1.993|`terminal_lost`|valid:124, terminal_lost:34, no_detection:31, bbox_bottom_clipped:9|77.2%|70.8%|

- LOS KF 参数：`q_lambda=0.0005`、`q_lambda_dot=0.02`、`r=0.008`、`innovation_reject=0.75`、`terminal_reject=1.2`。
- 未命中但最近距离小于等于 3m 的工况：VM 30m(2.668m)，VM 50m(1.993m)。这些工况已接近目标，但没有触发 AirSim 碰撞判定，后续应重点看末端视场保持、外推和碰撞几何。
- 最近点处仍处于降级或无效状态的未命中工况：VM 30m:`terminal_lost`，VM 50m:`terminal_lost`。这些样本说明末端质量门、视觉外推和 bbox 裁切处理仍会影响命中窗口。
- 本轮平均实际过载峰值约 `1.08 g`，平均需用过载 P95 约 `1.38 g`。两者不是同一个量：`n_cmd_g` 是导引层需求，实际过载还受 PX4 姿态/推力限制、YOLO 约 9 FPS 采样和 frame centering 限速影响。

## 8. 相机光心真值影子测试诊断

![shadow_summary](assets/YOLO_ByteTrack_upward_final_more_25_30_45_50测试报告/shadow_summary_upward_final_yolo_more_20260628_174009.png)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|TTC|25|1|1.622|71.4%|2/7|36.1|0.66|2.64|0.82|0.81|
|VM|25|0|3.057|100.0%|0/12|30.1|0.21|1.97|1.87|1.40|
|TTC|30|1|1.881|87.5%|1/8|32.4|0.69|3.29|1.79|0.96|
|VM|30|0|2.668|81.8%|2/11|22.7|0.21|2.24|1.98|1.36|
|TTC|45|1|1.610|100.0%|0/7|39.3|0.27|0.74|0.84|0.86|
|VM|45|1|1.512|83.3%|1/6|28.9|0.23|0.59|1.22|0.99|
|TTC|50|1|1.760|66.7%|2/6|34.5|0.32|0.82|0.57|0.90|
|VM|50|0|1.993|72.7%|3/11|97.8|0.26|2.52|1.99|1.34|
...
|---|---:|---:|---:|---:|---|---|---|
|TTC|25|1.622|81.4%|0.0%|120.0/120.0/60.0|31.2/30.4|0.30/0.83|
|VM|25|3.057|66.2%|36.3%|120.0/120.0/60.0|35.0/35.0|0.25/0.85|
|TTC|30|1.881|88.4%|10.1%|120.0/120.0/60.0|35.0/35.0|0.25/0.85|
|VM|30|2.668|88.5%|14.5%|120.0/120.0/60.0|35.0/35.0|0.25/0.85|
|TTC|45|1.610|92.3%|5.1%|120.0/120.0/60.0|35.0/35.0|0.25/0.85|
|VM|45|1.512|91.5%|2.8%|120.0/120.0/60.0|35.0/35.0|0.25/0.85|
|TTC|50|1.760|97.0%|8.1%|120.0/120.0/60.0|35.0/35.0|0.25/0.85|
|VM|50|1.993|73.8%|31.7%|120.0/120.0/60.0|35.0/35.0|0.25/0.85|
...
- TTC: 命中 `4/4`，命中距离 `25m, 30m, 45m, 50m`，未命中 `-`，检测帧比例 `80.7%`，有效导引帧比例 `78.8%`，平均检测 FPS `6.73`。
- VM: 命中 `1/4`，命中距离 `45m`，未命中 `25m, 30m, 50m`，检测帧比例 `73.2%`，有效导引帧比例 `66.3%`，平均检测 FPS `6.07`。
