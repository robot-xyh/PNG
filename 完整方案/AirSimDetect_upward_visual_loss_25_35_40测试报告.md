# AirSim Detect upward-camera visual-loss terminal TTC / V_m 25-40m test report
...
Fixed upward camera detect test after visual-loss-only terminal extrapolation: TTC and V_m at 25m, 35m, and 40m horizontal range.

## 2. 基准条件

|参数|值|
|---|---|
|stamp|`upward_visual_loss_detect_20260628_072911`|
...
![summary](assets/AirSimDetect_upward_visual_loss_25_35_40测试报告/summary_upward_visual_loss_detect_20260628_072911.png)

## 4. 汇总表

|组别|碰撞命中|近距命中|碰撞距离m|近距距离m|未命中距离m|最小中心距离m|检测帧/总帧|有效帧/总帧|平均检测FPS|
|---|---:|---:|---|---|---|---:|---:|---:|---:|
|TTC|0/3|3/3|-|25, 35, 40|-|1.089|214/236|225/236|2031.99|
|VM|0/3|3/3|-|25, 35, 40|-|1.081|216/223|219/223|2055.26|

## 5. 明细表

|组别|距离m|碰撞|近距|碰撞时间s|近距时间s|近距距离m|最小距离m|终点距离m|检测帧率|有效帧率|YOLO FPS|sim FPS|实际过载max g|速度指令差分P95 g|需用过载P95 g|
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|TTC|25|0|1|-|9.90|1.313|1.313|1.313|85.0%|91.2%|2056.74|7.98|0.65|2.13|0.63|
|VM|25|0|1|-|9.02|1.218|1.218|1.218|90.4%|94.5%|2107.64|7.98|0.59|1.52|0.63|
|TTC|35|0|1|-|9.52|1.089|1.089|1.089|89.6%|94.8%|2025.37|7.98|0.57|1.31|0.96|
|VM|35|0|1|-|9.02|1.280|1.280|1.280|100.0%|100.0%|2095.50|7.98|0.58|0.31|0.47|
|TTC|40|0|1|-|9.77|1.162|1.162|1.162|97.5%|100.0%|2013.85|7.98|0.59|0.71|0.48|
|VM|40|0|1|-|9.52|1.081|1.081|1.081|100.0%|100.0%|1962.63|7.98|0.55|0.71|0.49|

## 6. 分距离曲线

每个距离一张图，包含真实中心距离、bbox 面积、TTC 估计、实际过载/需用过载和 YOLO 检测 FPS。

![25m](assets/AirSimDetect_upward_visual_loss_25_35_40测试报告/yolo_sitl_ttc_vm_025m.png)
![35m](assets/AirSimDetect_upward_visual_loss_25_35_40测试报告/yolo_sitl_ttc_vm_035m.png)
![40m](assets/AirSimDetect_upward_visual_loss_25_35_40测试报告/yolo_sitl_ttc_vm_040m.png)

## 7. LOS KF 与失败原因诊断

|组别|距离m|最近距离m|最近点状态|主要失败/降级原因|检测率|有效率|
|---|---:|---:|---|---|---:|---:|
|TTC|25|1.313|`bbox_bottom_clipped`|valid:54, area_not_expanding:10, no_detection:6, image_kf_predict:5|85.0%|91.2%|
|VM|25|1.218|`valid`|valid:66, image_kf_predict:3, no_detection:2, terminal_lost:2|90.4%|94.5%|
|TTC|35|1.089|`bbox_bottom_clipped`|valid:48, area_not_expanding:15, bbox_bottom_clipped:5, image_kf_predict:4|89.6%|94.8%|
|VM|35|1.280|`valid`|valid:73|100.0%|100.0%|
|TTC|40|1.162|`bbox_bottom_clipped`|valid:63, area_not_expanding:10, bbox_bottom_clipped:4, image_kf_predict:2|97.5%|100.0%|
|VM|40|1.081|`valid`|valid:77|100.0%|100.0%|

- LOS KF 参数：`q_lambda=0.0005`、`q_lambda_dot=0.02`、`r=0.008`、`innovation_reject=0.75`、`terminal_reject=1.2`。
- 未命中但最近距离小于等于 3m 的工况：TTC 25m(1.313m)，VM 25m(1.218m)，TTC 35m(1.089m)，VM 35m(1.280m)，TTC 40m(1.162m)，VM 40m(1.081m)。这些工况已接近目标，但没有触发 AirSim 碰撞判定，后续应重点看末端视场保持、外推和碰撞几何。
...
- 本轮平均实际过载峰值约 `0.59 g`，平均需用过载 P95 约 `0.61 g`。两者不是同一个量：`n_cmd_g` 是导引层需求，实际过载还受 PX4 姿态/推力限制、YOLO 约 9 FPS 采样和 frame centering 限速影响。

## 8. 相机光心真值影子测试诊断

![shadow_summary](assets/AirSimDetect_upward_visual_loss_25_35_40测试报告/shadow_summary_upward_visual_loss_detect_20260628_072911.png)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|TTC|25|0|1.313|87.5%|1/8|3.8|0.34|0.71|0.63|0.65|
|VM|25|0|1.218|87.5%|1/8|2.8|0.28|0.54|0.63|0.59|
|TTC|35|0|1.089|100.0%|0/8|20.2|0.35|0.67|0.96|0.57|
|VM|35|0|1.280|100.0%|0/8|3.4|0.34|0.52|0.47|0.58|
|TTC|40|0|1.162|87.5%|1/8|3.0|0.36|0.55|0.48|0.59|
|VM|40|0|1.081|100.0%|0/8|5.2|0.32|0.47|0.49|0.55|
...
|---|---:|---:|---:|---:|---|---|---|
|TTC|25|1.313|46.2%|1.2%|120.0/120.0/60.0|35.0/35.0|0.25/0.82|
|VM|25|1.218|26.0%|1.4%|120.0/120.0/60.0|35.0/35.0|0.39/0.85|
|TTC|35|1.089|90.9%|6.5%|120.0/120.0/42.4|28.0/35.0|0.55/0.85|
|VM|35|1.280|94.5%|0.0%|35.9/120.0/34.5|11.6/33.9|0.60/0.79|
|TTC|40|1.162|100.0%|0.0%|60.5/120.0/37.4|15.1/35.0|0.62/0.81|
|VM|40|1.081|100.0%|0.0%|36.0/120.0/36.9|11.6/35.0|0.60/0.83|
...
- TTC: 命中 `0/3`，命中距离 `-`，未命中 `25m, 35m, 40m`，检测帧比例 `90.7%`，有效导引帧比例 `95.3%`，平均检测 FPS `2031.99`。
- VM: 命中 `0/3`，命中距离 `-`，未命中 `25m, 35m, 40m`，检测帧比例 `96.9%`，有效导引帧比例 `98.2%`，平均检测 FPS `2055.26`。
