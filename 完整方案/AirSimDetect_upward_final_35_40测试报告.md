...
|参数|值|
|---|---|
|stamp|`upward_final_detect_35_40_20260628_092150`|
...
![summary](assets/AirSimDetect_upward_final_35_40测试报告/summary_upward_final_detect_35_40_20260628_092150.png)

## 4. 汇总表

|组别|碰撞命中|近距命中|碰撞距离m|近距距离m|未命中距离m|最小中心距离m|检测帧/总帧|有效帧/总帧|平均检测FPS|
|---|---:|---:|---|---|---|---:|---:|---:|---:|
|TTC|2/2|2/2|35, 40|35, 40|-|0.453|156/160|158/160|1277.42|
|VM|2/2|2/2|35, 40|35, 40|-|0.663|150/156|154/156|1293.60|

## 5. 明细表

|组别|距离m|碰撞|近距|碰撞时间s|近距时间s|近距距离m|最小距离m|终点距离m|检测帧率|有效帧率|YOLO FPS|sim FPS|实际过载max g|速度指令差分P95 g|需用过载P95 g|
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|TTC|35|1|1|9.78|9.41|1.484|0.453|0.453|96.2%|100.0%|1280.52|7.97|0.61|0.65|0.84|
|VM|35|1|1|9.41|9.16|1.262|0.739|0.941|94.7%|100.0%|1271.35|7.97|0.58|0.57|0.53|
|TTC|40|1|1|10.03|9.78|1.211|0.674|1.032|98.8%|97.5%|1274.31|7.98|0.60|0.73|0.49|
|VM|40|1|1|9.91|9.66|1.268|0.663|0.663|97.5%|97.5%|1315.84|7.98|0.60|0.73|0.50|

## 6. 分距离曲线

每个距离一张图，包含真实中心距离、bbox 面积、TTC 估计、实际过载/需用过载和 YOLO 检测 FPS。

![35m](assets/AirSimDetect_upward_final_35_40测试报告/yolo_sitl_ttc_vm_035m.png)
![40m](assets/AirSimDetect_upward_final_35_40测试报告/yolo_sitl_ttc_vm_040m.png)

## 7. LOS KF 与失败原因诊断

|组别|距离m|最近距离m|最近点状态|主要失败/降级原因|检测率|有效率|
|---|---:|---:|---|---|---:|---:|
|TTC|35|0.453|`bbox_bottom_clipped`|valid:60, area_not_expanding:14, image_kf_predict:3, bbox_bottom_clipped:2|96.2%|100.0%|
|VM|35|0.739|`bbox_bottom_clipped`|valid:70, image_kf_predict:4, bbox_bottom_clipped:2|94.7%|100.0%|
|TTC|40|0.674|`bbox_bottom_clipped`|valid:64, area_not_expanding:10, bbox_bottom_clipped:6, image_kf_predict:1|98.8%|97.5%|
|VM|40|0.663|`bbox_bottom_clipped`|valid:72, bbox_bottom_clipped:6, image_kf_predict:2|97.5%|97.5%|

- LOS KF 参数：`q_lambda=0.0005`、`q_lambda_dot=0.02`、`r=0.008`、`innovation_reject=0.75`、`terminal_reject=1.2`。
- 本轮平均实际过载峰值约 `0.60 g`，平均需用过载 P95 约 `0.59 g`。两者不是同一个量：`n_cmd_g` 是导引层需求，实际过载还受 PX4 姿态/推力限制、YOLO 约 9 FPS 采样和 frame centering 限速影响。

## 8. 相机光心真值影子测试诊断

![shadow_summary](assets/AirSimDetect_upward_final_35_40测试报告/shadow_summary_upward_final_detect_35_40_20260628_092150.png)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|TTC|35|1|0.453|100.0%|0/8|37.6|0.39|0.86|0.84|0.61|
|VM|35|1|0.739|88.9%|1/9|33.2|0.35|0.52|0.53|0.58|
|TTC|40|1|0.674|100.0%|0/9|21.8|0.37|0.57|0.49|0.60|
|VM|40|1|0.663|100.0%|0/8|18.3|0.32|0.49|0.50|0.60|
...
|---|---:|---:|---:|---:|---|---|---|
|TTC|35|0.453|94.9%|3.8%|120.0/120.0/38.8|35.0/35.0|0.25/0.85|
|VM|35|0.739|93.4%|1.3%|79.2/120.0/34.3|16.7/34.5|0.52/0.85|
|TTC|40|0.674|100.0%|0.0%|55.5/120.0/36.5|14.5/35.0|0.36/0.75|
|VM|40|0.663|100.0%|1.2%|65.0/120.0/36.9|12.6/35.0|0.49/0.85|
...
- TTC: 命中 `2/2`，命中距离 `35m, 40m`，未命中 `-`，检测帧比例 `97.5%`，有效导引帧比例 `98.8%`，平均检测 FPS `1277.42`。
- VM: 命中 `2/2`，命中距离 `35m, 40m`，未命中 `-`，检测帧比例 `96.2%`，有效导引帧比例 `98.7%`，平均检测 FPS `1293.60`。
