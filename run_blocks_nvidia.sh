...
if [[ -n "$SETTINGS_ARG" ]]; then
  ...
  export AIRSIM_SETTINGS_PATH_RESOLVED AIRSIM_RPC_HOST AIRSIM_RPC_PORT AIRSIM_PX4_TCP_PORTS AIRSIM_PORT_POLICY AIRSIM_PORT_REWRITTEN AIRSIM_LOCALHOST_IP
  ...
  AIRSIM_LOCALHOST_IP="127.0.0.1"
  export AIRSIM_RPC_HOST AIRSIM_RPC_PORT AIRSIM_LOCALHOST_IP
fi
...
echo "AirSim/PX4 localhost IP: ${AIRSIM_LOCALHOST_IP:-127.0.0.1}"
